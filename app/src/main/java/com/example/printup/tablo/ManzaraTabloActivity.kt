...
import com.example.printup.databinding.ActivityManzaraTabloBinding
...
class ManzaraTabloActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private var db = Firebase.firestore
    private lateinit var storage: FirebaseStorage
    private lateinit var docid: String
    private lateinit var binding: ActivityManzaraTabloBinding
    private lateinit var tabloArrayList: ArrayList<Tablo>
    private lateinit var tabloAdapter: TabloAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityManzaraTabloBinding.inflate(layoutInflater)
    ...
    fun verileriAl() {
        db.collection("manzaratablolar").addSnapshotListener { value, error ->
