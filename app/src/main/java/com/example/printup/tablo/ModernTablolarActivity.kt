...
import com.example.printup.databinding.ActivityModernTablolarBinding
...
class ModernTablolarActivity : AppCompatActivity() {
    private lateinit var auth: FirebaseAuth
    private var db = Firebase.firestore
    private lateinit var storage: FirebaseStorage
    private lateinit var docid: String
    private lateinit var binding: ActivityModernTablolarBinding
    private lateinit var tabloArrayList: ArrayList<Tablo>
    private lateinit var tabloAdapter: TabloAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityModernTablolarBinding.inflate(layoutInflater)
    ...
    fun verileriAl() {
        db.collection("moderntablolar").addSnapshotListener { value, error ->
