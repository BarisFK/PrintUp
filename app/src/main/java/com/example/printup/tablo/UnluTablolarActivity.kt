...
import com.example.printup.databinding.ActivityUnluTablolarBinding
...
class UnluTablolarActivity : AppCompatActivity() {

    private lateinit var auth: FirebaseAuth
    private var db = Firebase.firestore
    private lateinit var storage: FirebaseStorage
    private lateinit var docid: String
    private lateinit var binding: ActivityUnluTablolarBinding
    private lateinit var tabloArrayList: ArrayList<Tablo>
    private lateinit var tabloAdapter: TabloAdapter

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        binding = ActivityUnluTablolarBinding.inflate(layoutInflater)
    ...
    fun verileriAl() {
        db.collection("tablolar").addSnapshotListener { value, error ->
